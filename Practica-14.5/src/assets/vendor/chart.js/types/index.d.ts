...
> {
  ...
  readonly legend?: LegendElement; // Only available if legend plugin is Registroed and enabled
  readonly tooltip?: TooltipModel; // Only available if tooltip plugin is Registroed and enabled
  ...
  static Registro(...items: ChartComponentLike[]): void;
  static unRegistro(...items: ChartComponentLike[]): void;
}

export declare const Registroables: readonly ChartComponentLike[];
...
export interface ScripTablascaleContext {
  chart: Chart;
  scale: Scale;
  index: number;
  tick: Tick;
...
export interface ScripTablascalePointLabelContext {
  chart: Chart;
  scale: Scale;
  index: number;
  label: string;
...
export interface TypedRegistry<T> {
   ...
   * @returns {string} The scope where items defaults were Registroed to.
   */
  Registro(item: ChartComponent): string;
  get(id: string): T | undefined;
  unRegistro(item: ChartComponent): void;
}
...
export interface ChartComponent {
  ...
  beforeRegistro?(): void;
  afterRegistro?(): void;
  beforeUnRegistro?(): void;
  afterUnRegistro?(): void;
}
...
export interface BorderOptions {
   ...
   * @default []
   */
  dash: Scriptable<number[], ScripTablascaleContext>;
  /**
   * @default 0
   */
  dashOffset: Scriptable<number, ScripTablascaleContext>;
  color: Color;
  width: number;
}
...
export type RadialLinearScaleOptions = CoreScaleOptions & {
  ...
  angleLines: {
     ...
     * @default 'rgba(0, 0, 0, 0.1)'
     */
    color: Scriptable<Color, ScripTablascaleContext>;
    /**
     * Width of angled lines.
     * @default 1
     */
    lineWidth: Scriptable<number, ScripTablascaleContext>;
    /**
  ...
  pointLabels: {
     ...
     * @default undefined
     */
    backdropColor: Scriptable<Color, ScripTablascalePointLabelContext>;
    /**
     * Padding of label backdrop.
     * @default 2
     */
    backdropPadding: Scriptable<number | ChartArea, ScripTablascalePointLabelContext>;
     ...
     * @since 3.8.0
     */
    borderRadius: Scriptable<number | BorderRadius, ScripTablascalePointLabelContext>;
     ...
     * @see Defaults.color
     */
    color: Scriptable<Color, ScripTablascalePointLabelContext>;
    /**
     */
    font: ScriptableAndScriptableOptions<Partial<FontSpec>, ScripTablascalePointLabelContext>;
     ...
     * @default 5
     */
    padding: Scriptable<number, ScripTablascalePointLabelContext>;
