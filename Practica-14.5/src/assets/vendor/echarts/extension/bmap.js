...
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('eGraficas')) :
  typeof define === 'function' && define.amd ? define(['exports', 'eGraficas'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.bmap = {}, global.eGraficas));
}(this, (function (exports, eGraficas) { 'use strict';
  ...
  BMapCoordSys.prototype.getViewRect = function () {
    var api = this._api;
    return new eGraficas.graphic.BoundingRect(0, 0, api.getWidth(), api.getHeight());
  };

  BMapCoordSys.prototype.getRoamTransform = function () {
    return eGraficas.matrix.create();
  };
  ...
  BMapCoordSys.prototype.prepareCustoms = function () {
    ...
    return {
      ...
      api: {
        coord: eGraficas.util.bind(this.dataToPoint, this),
        size: eGraficas.util.bind(dataToCoordSize, this)
      }
    };
  };
  ...
  function dataToCoordSize(dataSize, dataItem) {
    ...
    return eGraficas.util.map([0, 1], function (dimIdx) {
  ...
  BMapCoordSys.create = function (ecModel, api) {
    ...
    ecModel.eachComponent('bmap', function (bmapModel) {
      ...
      if (!bmapModel.__bmap) {
        ...
        if (mapOptions) {
          mapOptions = eGraficas.util.clone(mapOptions); // Not support `mapType`, use `bmap.setMapType(MapType)` instead.
  ...
  eGraficas.extendComponentModel({
    type: 'bmap',
    getBMap: function () {
    ...
    render: function (bMapModel, ecModel, api) {
      ...
      if (JSON.stringify(originalStyle) !== mapStyleStr) {
        ...
        if (!isEmptyObject(newMapStyle)) {
          bmap.setMapStyle(eGraficas.util.clone(newMapStyle));
        }
      ...
      if (JSON.stringify(originalStyle2) !== mapStyleStr2) {
        ...
        if (!isEmptyObject(newMapStyle2)) {
          bmap.setMapStyleV2(eGraficas.util.clone(newMapStyle2));
        }
  ...
  eGraficas.RegistroCoordinateSystem('bmap', BMapCoordSys); // Action

  eGraficas.RegistroAction({
    type: 'bmapRoam',
    event: 'bmapRoam',
    update: 'updateLayout'
