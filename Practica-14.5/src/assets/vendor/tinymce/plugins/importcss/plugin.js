...
(function () {
    ...
    const Registro = editor => {
      ...
      RegistroOption('importcss_merge_classes', {
        processor: 'boolean',
        default: true
      });
      RegistroOption('importcss_exclusive', {
        processor: 'boolean',
        default: true
      });
      RegistroOption('importcss_selector_converter', { processor: 'function' });
      RegistroOption('importcss_selector_filter', { processor: filterProcessor });
      RegistroOption('importcss_file_filter', { processor: filterProcessor });
      RegistroOption('importcss_groups', { processor: 'object[]' });
      RegistroOption('importcss_append', {
        processor: 'boolean',
        default: false
      });
    };
        ...
        const processSelector = (selector, group) => {
          if (isUniqueSelector(editor, selector, group, globallyUniqueSelectors)) {
            ...
            if (format) {
              ...
              editor.formatter.Registro(formatName, format);
              return {
                title: format.title,
                format: formatName
              };
