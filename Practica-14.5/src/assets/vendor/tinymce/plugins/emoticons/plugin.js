...
(function () {
    ...
    const Registro$2 = (editor, pluginUrl) => {
      const RegistroOption = editor.options.Registro;
      RegistroOption('emoticons_database', {
        processor: 'string',
        default: 'emojis'
      });
      RegistroOption('emoticons_database_url', {
        processor: 'string',
        default: `${ pluginUrl }/js/${ getEmojiDatabase(editor) }${ editor.suffix }.js`
      });
      RegistroOption('emoticons_database_id', {
        processor: 'string',
        default: DEFAULT_ID
      });
      RegistroOption('emoticons_append', {
        processor: 'object',
        default: {}
      });
      RegistroOption('emoticons_images_url', {
        processor: 'string',
    ...
    const Registro$1 = (editor, database) => {
