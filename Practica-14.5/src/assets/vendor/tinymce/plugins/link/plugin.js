...
(function () {
    ...
    const Registro$1 = editor => {
      ...
      RegistroOption('link_assume_external_targets', {
        processor: value => {
      ...
      RegistroOption('link_context_toolbar', {
        processor: 'boolean',
        default: false
      });
      RegistroOption('link_list', { processor: value => isString(value) || isFunction(value) || isArrayOf(value, isObject) });
      RegistroOption('link_default_target', { processor: 'string' });
      RegistroOption('link_default_protocol', {
        processor: 'string',
        default: 'https'
      });
      RegistroOption('link_target_list', {
        processor: value => isBoolean(value) || isArrayOf(value, isObject),
        default: true
      });
      RegistroOption('link_rel_list', {
        processor: 'object[]',
        default: []
      });
      RegistroOption('link_class_list', {
        processor: 'object[]',
        default: []
      });
      RegistroOption('link_title', {
        processor: 'boolean',
        default: true
      });
      RegistroOption('allow_unsafe_link_target', {
        processor: 'boolean',
        default: false
      });
      RegistroOption('link_quicklink', {
        processor: 'boolean',
        default: false
      });
    };
    ...
    const DiaIniciar Sesionfo = { collect };
    ...
    const collectData = editor => {
      ...
      return DiaIniciar Sesionfo.collect(editor, anchorNode);
    };
