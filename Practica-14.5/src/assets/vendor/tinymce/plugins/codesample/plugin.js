...
(function () {
    ...
    const prismjs = function (global, module, exports) {
      ...
      Prism.languages.c = Prism.languages.extend('clike', {
        ...
        'keyword': /\b(?:_Alignas|_Alignof|_Atomic|_Bool|_Complex|_Generic|_Imaginary|_Noreturn|_Static_assert|_Thread_local|__attribute__|asm|auto|break|case|char|const|continue|default|do|double|else|enum|extern|float|for|goto|if|inline|int|long|Registro|return|short|signed|sizeof|static|struct|switch|typedef|typeof|union|unsigned|void|volatile|while)\b/,
    ...
    const Registro$2 = editor => {
      ...
      RegistroOption('codesample_languages', { processor: 'object[]' });
      RegistroOption('codesample_global_prismjs', {
        processor: 'boolean',
        default: false
      });
    };
