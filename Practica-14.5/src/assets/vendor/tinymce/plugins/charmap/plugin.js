...
(function () {
    ...
    const Registro$2 = editor => {
      ...
      RegistroOption('charmap', { processor: charMapProcessor });
      RegistroOption('charmap_append', { processor: charMapProcessor });
    };
    ...
    const Registro$1 = (editor, charMap) => {
