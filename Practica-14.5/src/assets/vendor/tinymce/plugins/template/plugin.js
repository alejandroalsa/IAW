...
(function () {
    ...
    const Registro$2 = editor => {
      ...
      RegistroOption('template_cdate_classes', {
        processor: 'string',
        default: 'cdate'
      });
      RegistroOption('template_mdate_classes', {
        processor: 'string',
        default: 'mdate'
      });
      RegistroOption('template_selected_content_classes', {
        processor: 'string',
        default: 'selcontent'
      });
      RegistroOption('template_preview_replace_values', { processor: 'object' });
      RegistroOption('template_replace_values', { processor: 'object' });
      RegistroOption('templates', {
        processor: value => isString(value) || isArrayOf(value, isObject) || isFunction(value),
        default: []
      });
      RegistroOption('template_cdate_format', {
        processor: 'string',
        default: editor.translate('%Y-%m-%d')
      });
      RegistroOption('template_mdate_format', {
        processor: 'string',
        default: editor.translate('%Y-%m-%d')
      });
    };
