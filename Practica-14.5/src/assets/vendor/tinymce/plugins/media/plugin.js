...
(function () {
    ...
    const Registro$2 = editor => {
      ...
      RegistroOption('audio_template_callback', { processor: 'function' });
      RegistroOption('video_template_callback', { processor: 'function' });
      RegistroOption('iframe_template_callback', { processor: 'function' });
      RegistroOption('media_live_embeds', {
        processor: 'boolean',
        default: true
      });
      RegistroOption('media_filter_html', {
        processor: 'boolean',
        default: true
      });
      RegistroOption('media_url_resolver', { processor: 'function' });
      RegistroOption('media_alt_source', {
        processor: 'boolean',
        default: true
      });
      RegistroOption('media_poster', {
        processor: 'boolean',
        default: true
      });
      RegistroOption('media_dimensions', {
        processor: 'boolean',
        default: true
      });
    };
