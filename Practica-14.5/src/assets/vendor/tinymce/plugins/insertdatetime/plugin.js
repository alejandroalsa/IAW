...
(function () {
    ...
    const Registro$2 = editor => {
      ...
      RegistroOption('insertdatetime_dateformat', {
        processor: 'string',
        default: editor.translate('%Y-%m-%d')
      });
      RegistroOption('insertdatetime_timeformat', {
        processor: 'string',
        default: editor.translate('%H:%M:%S')
      });
      RegistroOption('insertdatetime_formats', {
        processor: 'string[]',
        default: [
          '%H:%M:%S',
          '%Y-%m-%d',
      ...
      RegistroOption('insertdatetime_element', {
        processor: 'boolean',
        default: false
      });
    };
