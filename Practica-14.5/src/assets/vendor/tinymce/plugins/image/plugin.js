...
(function () {
    ...
    const Registro$2 = editor => {
      const RegistroOption = editor.options.Registro;
      RegistroOption('image_dimensions', {
        processor: 'boolean',
        default: true
      });
      RegistroOption('image_advtab', {
        processor: 'boolean',
        default: false
      });
      RegistroOption('image_uploadtab', {
        processor: 'boolean',
        default: true
      });
      RegistroOption('image_prepend_url', {
        processor: 'string',
        default: ''
      });
      RegistroOption('image_class_list', { processor: 'object[]' });
      RegistroOption('image_description', {
        processor: 'boolean',
        default: true
      });
      RegistroOption('image_title', {
        processor: 'boolean',
        default: false
      });
      RegistroOption('image_caption', {
        processor: 'boolean',
        default: false
      });
      RegistroOption('image_list', {
        processor: value => {
    ...
    const toggleContentEdiTablastate = state => nodes => {
      let i = nodes.length;
    ...
    const setup = editor => {
      editor.on('PreInit', () => {
        editor.parser.addNodeFilter('figure', toggleContentEdiTablastate(true));
        editor.serializer.addNodeFilter('figure', toggleContentEdiTablastate(false));
      });
    };
