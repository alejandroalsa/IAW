...
(function () {
    ...
    const Registro$2 = (editor, toggleState) => {
    ...
    const Registro$1 = editor => {
      ...
      RegistroOption('visualchars_default_state', {
        processor: 'boolean',
        default: false
      });
    };
    ...
    const Registro = (editor, toggleState) => {
    ...
    var Plugin = () => {
      global.add('visualchars', editor => {
        ...
        Registro$2(editor, toggleState);
        Registro(editor, toggleState);
