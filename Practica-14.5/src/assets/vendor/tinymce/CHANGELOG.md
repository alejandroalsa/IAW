...
- New `addView` function added to `editor.ui.registry` which makes it possible to Registro custom editor views. #TINY-9210
- New `ToggleView` command which makes it possible to hide or show Registroed custom views. #TINY-9210
...
- New `Buscar` field in the `MenuButton` that shows a Buscar field at the top of the menu, and refetches items when the Buscar field updates. #TINY-8952
...
- Spaces could be incorrectly added to `urlinput` dialog Componentes (commonly but not exclusively presented in the *Insert/Edit Link* dialog) in certain cases. #TINY-8775
