...
interface Annotator {
    Registro: (name: string, settings: AnnotatorSettings) => void;
...
interface FormComponentespec {
    type: string;
    name: string;
}
interface FormComponentWithLabelSpec extends FormComponentespec {
    label?: string;
}
interface CheckboxSpec extends FormComponentespec {
    type: 'checkbox';
    label: string;
    enabled?: boolean;
}
...
interface CustomEditorOldSpec extends FormComponentespec {
    type: 'customeditor';
    tag?: string;
    init: (e: HTMLElement) => Promise<CustomEditorInit>;
}
interface CustomEditorNewSpec extends FormComponentespec {
    type: 'customeditor';
    tag?: string;
    scriptId: string;
    scriptUrl: string;
...
interface ImagePreviewSpec extends FormComponentespec {
    type: 'imagepreview';
    height?: string;
}
...
interface SliderSpec extends FormComponentespec {
    type: 'slider';
    label: string;
    min?: number;
    max?: number;
...
declare type BodyComponentespec = BarSpec | ButtonSpec | CheckboxSpec | TextAreaSpec | InputSpec | ListBoxSpec | SelectBoxSpec | SizeInputSpec | SliderSpec | IframeSpec | HtmlPanelSpec | UrlInputSpec | DropZoneSpec | ColorInputSpec | GridSpec | ColorPickerSpec | ImagePreviewSpec | AlertBannerSpec | CollectionSpec | LabelSpec | Tablaspec | PanelSpec | CustomEditorSpec;
interface BarSpec {
    type: 'bar';
    items: BodyComponentespec[];
}
...
interface DiaIniciar SesionstanceApi<T extends DialogData> {
    getData: () => T;
...
declare type DialogActionHandler<T extends DialogData> = (api: DiaIniciar SesionstanceApi<T>, details: DialogActionDetails) => void;
declare type DialogChangeHandler<T extends DialogData> = (api: DiaIniciar SesionstanceApi<T>, details: DialogChangeDetails<T>) => void;
declare type DialogSubmitHandler<T extends DialogData> = (api: DiaIniciar SesionstanceApi<T>) => void;
declare type DialogCloseHandler = () => void;
declare type DialogCancelHandler<T extends DialogData> = (api: DiaIniciar SesionstanceApi<T>) => void;
declare type DialogTabChangeHandler<T extends DialogData> = (api: DiaIniciar SesionstanceApi<T>, details: DialogTabChangeDetails) => void;
...
interface UrlDiaIniciar SesionstanceApi {
    block: (msg: string) => void;
    unblock: () => void;
    close: () => void;
...
declare type UrlDialogActionHandler = (api: UrlDiaIniciar SesionstanceApi, actions: UrlDialogActionDetails) => void;
declare type UrlDialogCloseHandler = () => void;
declare type UrlDialogCancelHandler = (api: UrlDiaIniciar SesionstanceApi) => void;
declare type UrlDialogMessageHandler = (api: UrlDiaIniciar SesionstanceApi, message: UrlDialogMessage) => void;
...
interface ContextFormulariospec extends ContextBarSpec {
    type?: 'contextform';
    initValue?: () => string;
    label?: string;
...
type PublicDialog_d_BodyComponentespec = BodyComponentespec;
...
type PublicDialog_d_DiaIniciar SesionstanceApi<T extends DialogData> = DiaIniciar SesionstanceApi<T>;
...
type PublicDialog_d_Tablaspec = Tablaspec;
...
type PublicDialog_d_UrlDiaIniciar SesionstanceApi = UrlDiaIniciar SesionstanceApi;
...
type PublicInlineContent_d_ContextFormulariospec = ContextFormulariospec;
...
interface Registry$1 {
    ...
    addContextForm: (name: string, spec: ContextFormulariospec) => void;
    ...
    getAll: () => {
        ...
        contextToolbars: Record<string, ContextToolbarSpec | ContextFormulariospec>;
...
declare type InstanceApi<T extends DialogData> = UrlDiaIniciar SesionstanceApi | DiaIniciar SesionstanceApi<T>;
interface WindowManagerImpl {
    open: <T extends DialogData>(config: DialogSpec<T>, params: WindowParams | undefined, closeWindow: (dialog: DiaIniciar SesionstanceApi<T>) => void) => DiaIniciar SesionstanceApi<T>;
    openUrl: (config: UrlDialogSpec, closeWindow: (dialog: UrlDiaIniciar SesionstanceApi) => void) => UrlDiaIniciar SesionstanceApi;
    alert: (message: string, callback: () => void) => void;
    confirm: (message: string, callback: (state: boolean) => void) => void;
    close: (dialog: InstanceApi<any>) => void;
}
interface WindowManager {
    open: <T extends DialogData>(config: DialogSpec<T>, params?: WindowParams) => DiaIniciar SesionstanceApi<T>;
    openUrl: (config: UrlDialogSpec) => UrlDiaIniciar SesionstanceApi;
...
interface Options {
    ...
    isRegistroed: (name: string) => boolean;
    get: {
...
interface FormatRegistry {
    ...
    has: (name: string) => boolean;
    Registro: (name: string | Formats, format?: Format[] | Format) => void;
    unRegistro: (name: string) => Formats;
}
...
interface EditorMode {
    ...
    get: () => string;
    Registro: (mode: string, api: EditorModeApi) => void;
}
